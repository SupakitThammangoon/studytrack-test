    ...
    <div className="h-screen w-full flex items-center justify-center bg-slate-800 p-4">
      <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800">StudyTrack</h1>
          <p className="text-gray-400 mt-2 text-sm">จัดการงานและโปรเจกต์อย่างเรียบง่าย</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-gray-500">
              ยังไม่มีบัญชี?
              <Link to="/register" className="text-blue-600 font-medium ml-1 hover:text-blue-700">
                สมัครสมาชิก
              </Link>
            </p>
          </div>
